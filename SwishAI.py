...
with mpipe_pose.Pose(min_detection_confidence=detect_conf_level,min_tracking_confidence=track_conf_level) as pose:
    ...
    while capture.isOpened():
        ...
        try:
            ...
            left_shoulder= [nodes[mpipe_pose.PoseLandmark.LEFT_SHOULDER.value].x,nodes[mpipe_pose.PoseLandmark.LEFT_SHOULDER.value].y]
            left_hip=[nodes[mpipe_pose.PoseLandmark.LEFT_HIP.value].x,nodes[mpipe_pose.PoseLandmark.LEFT_HIP.value].y]
            left_knee=[nodes[mpipe_pose.PoseLandmark.LEFT_KNEE.value].x,nodes[mpipe_pose.PoseLandmark.LEFT_KNEE.value].y]
            ##ankle maybe
